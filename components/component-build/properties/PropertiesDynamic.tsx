...
import classes from "@/components/elh2/assets/properties-type.module.css";
...
const PropertiesDynamic = ({
  ...
  return (
    <>
      <div
        className={`${classes.planCard} bordered border-1 h-fit lg:h-[65rem]`}
        data-aos="zoom-in"
      >
        <div
          className={`carousel w-full h-fit gap-4 bordered border-4 relative`}
        >
        ...
        >
          ...
          <Button
            ...
            className={`hover:bg-[#199249]  hover:text-[#199249] w-full btn bordered border-2  border-[#199249] mt-4 rounded-md`}
          >
          ...
          <Button
            ...
            className={`${langParagraph} w-full btn bordered border-2 bg-transparent hover:text-white hover:bg-[#199249] border-[#199249] mt-4 rounded-md`}
          >
            <p className={`${langParagraph} text-[1.3rem]`}>
              LAYOUT CONTRACTION
            </p>
          </Button>
          <Modal
            ...
            backdrop="blur"
            hideCloseButton
            className="flex justify-center items-center z-auto bg-transparent h-[800px] w-[620px]"
            size="5xl"
            radius="none"
            placement="center"
          >
                ...
                <ModalBody className={isCatlogeNotLayout ? "" : ""}>
                  {isCatlogeNotLayout ? (
                    ...
                    <ImageNextUI
                      src={`${layout}`}
                      width={720}
                      className="bordered border-3 p-4 rotate-90 mt-36"
                    />
                  )}
                </ModalBody>
              </>
