...
const Emc1Bedroom = () => {
      ...
      properties: [
        {
          ...
          descriptionItem: translateEmc2("emc2_1bed.land")
        },
        {
            iconItem: "/home-items/images/bedroom.png",
            descriptionItem: translateEmc2("emc2_1bed.bedroom")
          },
          {
            iconItem: "/home-items/images/livingroom.png",
            descriptionItem: translateEmc2("emc2_1bed.living_rooms")
          },
          {
            iconItem: "/home-items/images/bathroom.png",
            descriptionItem: translateEmc2("emc2_1bed.bath_room")
          },
          {
            iconItem: "/home-items/images/kitchen.png",
            descriptionItem: translateEmc2("emc2_1bed.kitchen")
          },
  ...
  const oneBedroomEMC3: ImageTypeDefinition[] = [
    {
      src: "/cataloge/images/emc2/1bedroom.jpg",
      alt: "1 Bedroom",
    },
