...
const Emc2Bedroom = () => {
  ...
  const flatCarouseSlides: ImageCarouselDefinition[] = [
    {
      src: "/allprojects/emc3_mp/2b_1.jpeg",
      alt: "1b",
    },
    {
        src: "/allprojects/emc3_mp/2b_2.jpeg",
      alt: "2b",
    },
    {
        src: "/allprojects/emc3_mp/2b_3.jpeg",
      alt: "3b",
    },
  ];
  const subUnitItems: SubUnitTpyDefinitions[] = [
    {
      key: "EMC MP 2 Bedroom",
      subUnitName: "EMC MP 1 Bedroom",
      properties: [
        {
          iconItem: "/home-items/images/land.png",
          descriptionItem: translateEplFlat("emc3_2bed.land")
        },
        {
            iconItem: "/home-items/images/bedroom.png",
            descriptionItem: translateEplFlat("emc3_2bed.bedroom")
          },
          {
            iconItem: "/home-items/images/livingroom.png",
            descriptionItem: translateEplFlat("emc3_2bed.living_rooms")
          },
          {
            iconItem: "/home-items/images/bathroom.png",
            descriptionItem: translateEplFlat("emc3_2bed.bath_room")
          },
          {
            iconItem: "/home-items/images/kitchen.png",
            descriptionItem: translateEplFlat("emc3_2bed.kitchen")
          },
  ...
  const oneBedroomEMC3: ImageTypeDefinition[] = [
    {
      src: "/cataloge/images/emc3/2bedroom.jpg",
      alt: "1 Bedroom",
    },
