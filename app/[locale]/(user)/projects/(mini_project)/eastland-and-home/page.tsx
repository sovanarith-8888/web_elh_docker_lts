...
import OurProperties from "@/components/elh2/OurProperties";
...
const EastLandPage = () => {
  ...
  const url = `https://www.google.com/maps/@11.6396556,104.9846312,3a,75y,94.65h,96.27t/data=!3m7!1e1!3m5!1spzBDxcSYmS2GRXKvnwFOYA!2e0!6shttps:%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fcb_client%3Dmaps_sv.tactile%26w%3D900%26h%3D600%26pitch%3D-6.272921937337811%26panoid%3DpzBDxcSYmS2GRXKvnwFOYA%26yaw%3D94.64500786038079!7i13312!8i6656?coh=205410&entry=ttu&g_ep=EgoyMDI0MDgyNi4wIKXMDSoASAFQAw%3D%3D`;
  const imageProjects = [
    "/master_image_project/ELH/background.jpg",
    "/master_image_project/ELH/bg2.png",
    "/master_image_project/ELH/bg3.png",
  ];
  return (
